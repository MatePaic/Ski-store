...
import { useAddCouponMutation, useRemoveCouponMutation } from "../../../features/shoppingCart/shoppingCartApi";

export default function OrderSummary() {
    const {subtotal, deliveryFee, discount, shoppingCart, total} = useShoppingCart();
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {shoppingCart?.coupon &&
                            <Box display='flex' justifyContent='space-between' alignItems='center'>
                                <Typography fontWeight='bold' variant='body2'>{shoppingCart.coupon.name} applied</Typography>
